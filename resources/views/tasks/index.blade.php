                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleEditModal<?= $list->taskID ?>">Update Project Task for <?= $list->projectName ?></h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form class="forms-sample"  action="<?= env('APP_URL')."/v1/tasks/update/$id" ?>" method="POST">
                                                <!-- CSRF Token -->
                                                <?= csrf_field() ?>
                            ...
                            <div class="modal fade" id="exampleDeleteModal<?= $list->taskID ?>" tabindex="-1" aria-labelledby="exampleDeleteModal<?= $list->taskID ?>" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="forms-sample"  action="<?= env('APP_URL')."/v1/tasks/delete/$id" ?>" method="POST">
                                                <!-- CSRF Token -->
                                                <?= csrf_field() ?>
                                                <div id="alert-msg"></div>
                                                <div class="form-group">
                                                    <p>You are about to delete task for project <?= $list->projectName ?></p>
                                                </div>
            ...
            <div class="modal-body">
                <form class="forms-sample" id="AddForm">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select mb-3" name="project_id" id="single-select-field" data-placeholder="Choose one thing" reqiured>
